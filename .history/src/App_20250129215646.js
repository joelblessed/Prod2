      ...
      <Router>
        ...
        <Routes>
          ...
          <Route
            path="/newProduct"
            element={
            <ProtectedRoute allowedRoles={['admin','user']}><ne</ProtectedRoute> 
            }
          />
          ...
          <Route
            ...
            element={
              ...
              <ProtectedRoute allowedRoles={['admin','user']}><NewProduct /> : <Navigate to="/signIN" /></ProtectedRoute>
            }
          />

          <Route
            path="checkout"
            element={<ProtectedRoute allowedRoles={['admin','user']}><NewProduct /> : <Navigate to="/signIN" /></ProtectedRoute>}
          />
