    ...
    <AuthProvider>
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route
            path="/editProfile"
            element={<EditProfile api={api} userInfo={user} error={error} />}
          />
          <Route path="/wishlist" element={<WishList api={api} />} />
          <Route path="/editProduct" element={   <ProtectedRoute allowedRoles={["admin", "user"]}>
                <ProductsByOwner api={api<EditProduct api={api} />} />
              </ProtectedRoute>} />
          <Route
