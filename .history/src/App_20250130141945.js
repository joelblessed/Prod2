...
function App() {
  ...
  const AuthContext = createContext();
   ...
   useEffect(() => {
    setApi("https://prod2-api.onrender.com")
    ...
    <AuthProvider>
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route path="/signIN" element={<SignIN api={api}  onSignIn={handleSignIn} />} />
          ...
          />
           ...
           <Route
            path="/Cart2"
            element={
              <Cart2 api={api} searchTerm={searchTerm} highlightText={highlightText} />
            }
          ></Route>
          ...
          <Route
            path="/newProduct"
            element={
            <ProtectedRoute allowedRoles={['admin','user']}><NewProduct api={api} /></ProtectedRoute> 
            }
          />
          ...
          <Route
            ...
            element={
              ...
              <ProtectedRoute allowedRoles={['admin','user']}><Dashboard api={api} /></ProtectedRoute>
            }
          />

          <Route
            path="checkout"
            element={<ProtectedRoute allowedRoles={['admin','user']}><Checkout api={api} /></ProtectedRoute>}
          />
