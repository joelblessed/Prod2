...
function App() {
 ...
 if (loading){
  ...
  <Payment/>
    <Routes>
      <Route path="/" element={<Home filteredProducts={filteredProducts}  setSelectedProduct={selectedProduct} addToCart={addToCart} handleShowAlert={handleAlert} showAlert={showAlert} searchTerm={searchTerm} setSearchTerm={setSearchTerm} handleProductClick={setHandleProductClick}
      />}></Route>
      <Route path="/Products" element={<Products filteredProducts={filteredProducts} setSelectedProduct={setSelectedProduct} addToCart={addToCart} cart={cart} handleShowAlert={handleAlert} showAlert={showAlert} searchTerm={searchTerm} highlightText={highlightText} handleProductClick={setandleProductClick}/>}></Route>
