    ...
    <AuthProvider>
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route path="/brand" element={<Brand api={api} filteredProducts={filteredProducts} searchTerm={searchTerm}  />} />
          <Route path="/brand/:brandId" element={<BrandPage api={api} filteredProducts={filteredProducts} searchTerm={searchTerm}   />} />
          ...
          <Route
            ...
            element={
              <CategoryPage api={api} filteredProducts={filteredProducts}  api={api}
              items={products}
              filteredProducts={filteredProducts}
              selectedCategory={selectedCategory}
              highlightText={highlightText}
