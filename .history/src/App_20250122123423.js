      ...
      <Router>
        ...
        <Routes>
          ...
          <Route
            path="/Cart2"
            element={
              <Cart2 searchTerm={searchTerm} highlightText={highlightText} item={item} incrementQuantity={setIncrement} />
            }
          ></Route>
          <Route
          ...
          <Route path="/incrementCart" element={<ShoppingCart incrementQuantity={increment} incrementQuantity={setIncrementincrement} item={setItem}/>} />
