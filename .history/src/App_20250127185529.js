...
function App() {
  const [calalculateTotal, setPayment] = useState()
    ...
    <>
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route path="/checkout" element={<Checkout payment={setPayment} calculateTotal={calalculateTotal} setCalculateTotal={setCalculateTotal}/>} />
          <Route path="/Payment" element={<Payment payment={payment} anount={calalculateTotal} amount={setCalculateTotal} />} />
