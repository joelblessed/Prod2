...
function DesktopNavbar({cart, searchTerm, setSearchTerm, selectedCategory, setSelectedCategory}) {
    ...
    return (
        ...
        />
                ...
                <li href="#" style={{width:""}}> <NavLink to="/category"><select 
          defaultValue="All"
          style={{width:"auto", whiteSpace:"nowrap", border:"0px", background:"none", backgroundColor:"none" , color:"black" , cursor:"pointer"}}
