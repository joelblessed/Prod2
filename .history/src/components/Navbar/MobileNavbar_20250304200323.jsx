      ...
      <MobileMenu isOpen={isMenuOpen}>
        ...
        <li>
          ...
          <select  style={style.select}
              ...
              onChange={(e) => setSearchTerm(e.target.value)}
            >
              <option  style={style.NavLink} value="">{faAllergies}</option>
              {categories.map((category, index) => (
                <option  style={style.NavLink} onClick={search} onChange={(e) => setCategory(e.target.value)} key={index} value={category}>{category}</option>
              ))}
            </select>
