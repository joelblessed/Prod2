    ...
    <nav style={styles.navbar}>
      ...
      <div style={styles.searchBox}>
        ...
        <button
          style={{
            ...styles.searchButton,
            transform: hoveredItem === "searchButton" ? "scale(1.2)" : "scale(1)",
          }}
          onClick={search}
          onMouseEnter={() => setHoveredItem("searchButton")}
      ...
      <ul style={styles.navList}>
        ...
        >
          <NavLink
            style={{
              ...styles.navLink,
              color: hoveredItem === "home" ? "#ff6600" : "red",
            }}
            to="/"
            exact
          >
        ...
        <li
          style={{
            ...styles.navItem,
            transform: hoveredItem === "products" ? "scale(1.1)" : "scale(1)",
          }}
        ...
        >
          <NavLink
            style={{
              ...styles.navLink,
              color: hoveredItem === "products" ? "#ff6600" : "red",
            }}
            to="/products"
          >
            Products
        ...
        <li
          style={{
            ...styles.navItem,
            transform: hoveredItem === "sell" ? "scale(1.1)" : "scale(1)",
          }}
        ...
        >
          <NavLink
            style={{
              ...styles.navLink,
              color: hoveredItem === "sell" ? "#ff6600" : "red",
            }}
            to="/formUpload"
          >
            Sell
        ...
        <li
          style={{
            ...styles.navItem,
            transform: hoveredItem === "category" ? "scale(1.1)" : "scale(1)",
          }}
        ...
        >
          <NavLink
            style={{
              ...styles.navLink,
              color: hoveredItem === "category" ? "#ff6600" : "red",
            }}
            to="/category"
          >
            <select
        ...
        <li
          style={{
            ...styles.navItem,
            transform: hoveredItem === "cart" ? "scale(1.1)" : "scale(1)",
          }}
        ...
        >
          <NavLink
            style={{
              ...styles.navLink,
              color: hoveredItem === "cart" ? "#ff6600" : "red",
            }}
            to="/cart"
          >
        ...
        >
          <NavLink
            style={{
              ...styles.navLink,
              color: hoveredItem === "account" ? "#ff6600" : "red",
            }}
            to="/dashboard"
          >
