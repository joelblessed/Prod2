...
function DesktopNavbar({cart, searchTerm, setSearchTerm, selectedCategory, setSelectedCategory}) {
    ...
    return (
      ...
      <div style={{display:"grid", background:"red"}}>
        <div style={{position:"absolute", top:"-10px",marginLeft:"9px"}}><label style={{color:"red", fontWeight:"bold"}}>{totalItems}</label></div>
      <div style={{display:"flex", background:"green",margin:"0px",padding:"0px"}}>  
