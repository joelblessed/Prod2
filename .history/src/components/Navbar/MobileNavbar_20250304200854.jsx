...
function MobileNavbar({
  ...
  const [category, setCategory] = useState ({searchTerm})
      ...
      <MobileMenu isOpen={isMenuOpen}>
        ...
        <li>
          ...
          <select  style={style.select}
              ...
              onChange={(e) => setSearchTerm(e.target.value)}
            >
              <option  style={style.NavLink} value="">{category}</option>
              {categories.map((category, index) => (
                <option  style={style.NavLink} onClick={search}  key={index} value={category}>{category}</option>
              ))}
            </select>
