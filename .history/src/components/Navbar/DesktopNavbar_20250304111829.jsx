...
import "./DesktopNavbar.css"; // Import the CSS file
  ...
  return (
    <nav>
      <ul>
        ...
        <li>
          <NavLink to="/Cart" activeClassName="active" className="cart-icon">
            <div>
              <div>
        ...
        <li>
          <NavLink to="/dashboard" activeClassName="active" className="user-profile">
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="48px"
