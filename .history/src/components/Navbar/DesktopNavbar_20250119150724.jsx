...
function DesktopNavbar({cart, searchTerm, setSearchTerm, selectedCategory, setSelectedCategory}) {
    ...
    return (
        ...
        />
                ...
                <li href="#" style={{width:"100px"}}> <NavLink to="/category"><select 
          defaultValue="All"
          style={{width:"100px", border:"0px", background:"none", backgroundColor:"none" ,width:"63px", color:"black" , cursor:"pointer"}}
