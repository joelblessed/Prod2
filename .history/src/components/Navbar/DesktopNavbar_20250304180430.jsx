...
function DesktopNavbar({ cartCount, searchTerm, setSearchTerm, categories, search }) {
      ...
      <NavList>
        ...
        <NavItem>
          <NavLinkStyled to="/category"> 
            <Styledselect style={{border:"none",background:"none", color:"red"}}
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
            >
              <Styledoption value="">Category</option>
