...
function DesktopNavbar({cart, searchTerm, setSearchTerm, selectedCategory, setSelectedCategory}) {
    ...
    return (
        ...
        <input className='Desk-searchbar' style={{borderRadius:"10px",border:"none", height:"40px", width:"300px"}}
        placeholder="search"
        type="text"
        value={searchTerm}
        defaultValue=""
        ...
        />
          ...
          >
            ...
            <li><NavLink to="/signIN" actiiveClassName="active">Sell</NavLink></li>
      ...
      <div style={{display:"flex", background:"",margin:"0px",padding:"0px"}}>  
        ...
        <div><a>cart</a></div>
            ...
            <li href="#">
                <NavLink to="/signUP" actiiveClassName="active"><div style={{background:"", marginTop:"-45px", marginRight:"0px"}}>
                <div><svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="50px" fill="#999999">
