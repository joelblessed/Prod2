...
function DesktopNavbar({cart, searchTerm, setSearchTerm, selectedCategory, setSelectedCategory}) {
    ...
    return (
        ...
        />
                ...
                <li href="#" style={{width:"fit-content"}}> <NavLink to="/category"><select 
          defaultValue="All"
          style={{width:"fit-content", border:"0px", background:"none", backgroundColor:"none" , color:"black" , cursor:"pointer"}}
