...
function MobileNavbar({
  ...
  const [isCategoryOpen, setIsCategoryOpen] = useState(false); // State for custom selector
  ...
  return (
    <>
      ...
      <ul style={styles.mobileMenu}>
        ...
        <li>
          <div style={styles.customSelector}>
            <button
            ...
            <div style={styles.customSelectorOptions}>
              {categories.map((category, index) => (
                <div
                  key={index}
                  style={styles.customSelectorOption}
                  onClick={() => {
