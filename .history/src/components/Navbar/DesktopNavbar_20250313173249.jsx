  ...
  return (
    <Navbar>
      ...
      <NavList>
        ...
        <NavItem>
          <NavLinkStyled onClick={search} to="/products">Products</NavLinkStyled>
        </NavItem>
        <NavItem>
        ...
        <NavItem>
          ...
          {imageError ?(
            ...
            style={{ borderRadius: "50%", borderBlockStart: " 2px solid red",borderBlockEnd: " 2px solid blue", borderBlockStartColor: "red",borderBlockEndColor: "blue" }}
          />
          )}
