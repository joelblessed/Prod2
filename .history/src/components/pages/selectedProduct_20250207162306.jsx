...
const SelectedProduct = ({api, SelectedProduct}) => {
  ...
  return (
    <div style={{ padding: "20px", margin: "0 auto",marginTop:"40px", maxWidth: "90%",maxHeight:"100vh", border:"1px solid green", borderRadius:"20px",boxShadow:"10px 10px 10px pink"}}>
