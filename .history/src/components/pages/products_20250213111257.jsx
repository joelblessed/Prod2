        ...
        {filteredProducts.length > 0 ? (
          filteredProducts.map((product, index) => (
            ...
            {isMobile ? (
              ...
              style={{
                ...styles.box,
                marginRight:index === filteredProducts.length -1 ? "1000px" : {} // Apply style only to the last box
              }}
            >
            ):(<div className="animated-box"
              key={index}
              ...
              style={{
                ...styles.box,
                marginRight:index === filteredProducts.length -1 ? "autox" : {} // Apply style only to the last box
              }}
            >)}
