...
const SelectedProduct = ({ api, selectedProduct }) => {
  const [product, setProduct] = useState(selectedProduct || localStorage.getItem("selectedProduct"));
  ...
  return (<>
    ...
    >
      <div style={{ display: "flex" }}>
        ...
        <div style={{ background: "#4ECDC4", width: "100%", marginLeft: "30px" }}>
        ...
        <div><button style={style.buttons} onClick={() => dispatch(addToCartBeforeLogin(product))}>Add To Cart</button></div>
        <div><button style={style.buttons} onClick={() => dispatch((product))}><a style={{fontSize:"30px",color:"orangered"}}>+</a>[add To WishList]</button></div>
