...
const SelectedProduct = ({ api, selectedProduct,filteredProducts, addToCart,addToWishList,likedProducts,searchTerm,cart,inwishlist,selectedCategory,highlightText,toggleLike, setS }) => {
