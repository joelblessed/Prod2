...
const Category = ({ filteredProducts, searchTerm, highlightText,addTowishList, addToCart}) => {
...
const styles = {
  container: { width: "80%", margin: "auto", marginTop:"90px" },
  categoryContainer: { marginBottom: "20px" },
  categoryTitle: { color: "teal"},
  productsGrid: { display: "flex", flexWrap: "wrap", gap: "10px" ,border:"1px solid red", width:"inherite"},
  productBox: {
    width: "250px",
    height: "250px",
    backgroundColor: "",
