    ...
    <div style={styles.container}>
      ...
      <div style={styles.mainContent}>
        <Routes>
          ...
          />
          <Route path="/dproducts" element={<Products products={products} handleDelete={handleDelete} useDispatch={useDispatch} />} />
          <Route path="/orders" element={<Orders orders={orders} />} />
          <Route path="/users" element={<Users users={users} />} />
          <Route path="/profile" element={<Profile users={users} api={api} />} />
