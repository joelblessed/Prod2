                ...
                <div className="col-lg-6">
                  <div className="form-group">
                    ...
                    {selectedValue === 'other' &&(
                        ...
                        <input style={{position:"absolute", top:"-38px", background:"",borderBlockStart:"2px solid green",borderBlockEnd:"2px solid yellow",borderBlockStart:"2px solid blue", outline:"red"}}
                         value={customValue}
