...
const Profile = ({ api, useDispatch }) => {
  ...
  const  [placeholderImage, setPlaceholderImage] = useState("/images/svgviewer-output(2).svg");
  useEffect(() => {
 ...
 useEffect(() => {
  if(user.gender === "male"){
    placeholderImage = "/images/svgviewer-output(2).svg";
  }
  else{
    placeholderImage = "/images/svgviewer-output(3).svg";
  }
 })
  return (
    <>
