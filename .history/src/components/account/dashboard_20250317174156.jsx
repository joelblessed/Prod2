    ...
    <div style={styles.container}>
      ...
      <div style={styles.mainContent}>
        <Routes>
          ...
          />
          <Route path="/dproducts" element={<Products products={products} />} />
...
<Link style={{border:"1px solid green",padding:"10px", borderRadius:"10px",color:"green", fontSize:"15px", fontWeight:"bold"}} to={`/editProduct/${product.id}`}>Edit Product</Link>
          </div>
        ))}
      </div>
    </div>
