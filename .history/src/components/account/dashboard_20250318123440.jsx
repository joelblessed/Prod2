    ...
    <div style={styles.container}>
      ...
      <div style={styles.mainContent}>
        <Routes>
          ...
          />
          <Route path="/dproducts" element={<Products products={products} handleDelete={handleDelete}  />} />
          <Route path="/orders" element={<Orders orders={orders} />} />
          <Route path="/users" element={<Users users={users} />} />
          <Route path="/dprofile" element={<Profile users={users} api={api} useDispatch={useDispatch}/>} />
...
const Profile = ({ api, useDispatch}) => {
  ...
  return (<>
    <div style={styles.profileContainer}>
      <h2>User Profile</h2>
      <img src={user.profileImage || 'public/images/svgviewer-output(2).svg} alt="Profile" style={styles.profileImage} />
