...
const SignUP = ({api}) => {
    ...
    const [country, countrychange] = useState("Cameroon");
    const [address, addresschange] = useState("");
    const [gender, genderchange] = useState("female");
    const [wallet, setWallet] = useState(0)
    const [city, setCity] = useState("")
    const [role, setRole] = useState("user")
    const [other, setOther] = usesta
    ...
    const handlesubmit = (e) => {
            e.preventDefault();
            let regobj = {  userName,fullName, password, email, phone, country,city, address, gender,wallet,role };
            if (IsValidate()) {
            //console.log(regobj);
            fetch(`${api}/signup`, {
                method: "POST",
                                ...
                                <div className="col-lg-6">
                                    <div className="form-group">
                                        ...
                                        <select value={country} onChange={e => countrychange(e.target.value)} className="form-control">
                                            ...
                                            <option value={other}><input value={other} onChange={e => setOther(e.target.value)} placeholder="Enter your country"></input></option>
                                        </select>
                                    </div>
                                </div>
