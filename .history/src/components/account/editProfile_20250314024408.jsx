...
const EditProfile = ({ api }) => {
  ...
  // 🔹 Handle form submissionSSSSSSss
    e.preventDefault();
    try {
      // 🟢 Update profile fields
      await axios.put(`${api}/profile/update `, { ...user, id: userId }, {
...
const styles = {
  form: { display: "flex", flexDirection: "column", maxWidth: "400px", margin: "0 auto", padding: "20px" },
  ...
  button: { padding: "10px 20px", borderRadius: "4px", border: "none", backgroundColor: "#007bff", color: "#fff" },
};
