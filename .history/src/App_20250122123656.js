      ...
      <Router>
        ...
        <Routes>
          ...
          <Route
            path="/Cart2"
            element={
              <Cart2 searchTerm={searchTerm} highlightText={highlightText} item={item} incrementQuantity={increment} incrementQuantity={setIncrement} />
            }
          ></Route>
          <Route
          ...
          <Route path="/incrementCart" element={<ShoppingCart incrementQuantity={setIncrement} incrementQuantity={increment} item={setItem}/>} />
