...
function App() {
 ...
 if (loading){
  ...
  <Payment/>
    <Routes>
      <Route path="/" element={<Home filteredProducts={filteredProducts} products={products} setSelectedProduct={setSent} addToCart={addToCart} handleShowAlert={handleAlert} showAlert={showAlert} searchTerm={searchTerm} setSearchTerm={setSearchTerm}
      />}></Route>
      <Route path="/Products" element={<Products setSelectedProduct={setSent} addToCart={addToCart} cart={cart} handleShowAlert={handleAlert} showAlert={showAlert} searchTerm={searchTerm} highlightText={highlightText} handleProductClick={setHandleProductClick}/>}></Route>
