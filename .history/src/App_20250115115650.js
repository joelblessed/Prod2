 ...
 if (loading){
  ...
  <Payment/>
    <Routes>
      ...
      />}></Route>
      <Route path="/Products" element={<Products filteredProducts={filteredProducts} setSelectedProduct={setSelectedProduct} addToCart={addToCart} cart={cart} handleShowAlert={handleAlert} showAlert={showAlert} searchTerm={searchTerm} highlightText={highlightText} handleProductClick={handleProductClick}/>}></Route>
