    ...
    <AuthProvider>
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route path="/profile" element={<Profile api={api} user={user} error={error}/>} />
          <Route path="/editProfile" element={<EditProfile api={api} userInfo={user} error={error} />} />
          <Route path="/wishlist" element={<WishList api={api} />} />
          <Route path="/editProduct" element={<EditProduct api={api} />} />
          <Route path="/calculateDistance" element={<CalculateDistance api={api} />} />
          <Route path="/productsByOwner" element={<ProtectedRoute allowedRoles={["admin", "user"]}>
                <Dashboard api={api} user={user} error={error} />
              </ProtectedRoute><ProductsByOwner api={api} />} />
          <Route
            path="/test"
            element={
              <Test
