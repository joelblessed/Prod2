...
function App() {
  ...
  const [displayusername, displayusernameupdate] = useState(userName);
    ...
    <AuthProvider>
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route
            path="/signIN"
            element={<SignIN api={api} onSignIn={handleSignIn} />}
          />
          ...
          <Route
            ...
            element={
              <ProtectedRoute allowedRoles={["admin", "user"]}>
                <Dashboard api={api} userName={userName} setUserName={setUserName} />
              </ProtectedRoute>
            }
          />
