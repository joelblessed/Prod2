...
function App() {
  ...
  const [checkout, setData] = useState()
    ...
    <>
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route path="/checkout" element={<Checkout  setCalculateTotal={setCalculateTotal} setCheckOut={setCheckOut}/>} />
          <Route path="/Payment" element={<Payment amount={calalculateTotal} Checkout={Checkout}/>} />
