...
function App() {
  ...
  const handleCalculateTotal = (newData)=>{
    setData(newData)
  }
  useEffect(() => {
    ...
    <>
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route path="/checkout" element={<Checkout payment={setPayment} calculateTotal={handleCalculateTotal}/>} />
          <Route path="/Payment" element={<Payment payment={payment} amount={calculateTotal} />} />
